...
public class Lista {
	...
	public static void main(String[] args) {
		...
		System.out.println("Exibir o elemento na posicao 2: " + numeros.get(2));
		
		System.out.println("Exibir o indice do elemento na posicao 10: " + numeros.indexOf(10));
		...
		//For Each, isso substitui o que esta em cima
